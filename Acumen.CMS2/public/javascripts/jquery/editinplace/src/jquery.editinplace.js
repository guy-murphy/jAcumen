...
// Guy Murphy: Modified line 225 from
...
// TO..
// data: settings.update_value + '=' + new_html + '&' + settings.element_id + '=' + original_element.attr(settings.element_id) + settings.params + '&' + settings.original_html + '=' + original_html,
